...
![テニス上達はコート外で決まる：浅く座る・骨盤を前に出す・顎を引く](/images/tennis-0601-posture-cover.png)
...
![浅く座る：椅子の前1/3で坐骨を立てて座る](/images/tennis-0601-shallow-sitting.svg)
...
![骨盤を前に出す：反り腰を消してニュートラルな背骨をつくる](/images/tennis-0601-pelvis-forward.svg)
...
![顎を引く：頭を背骨の真上に乗せて軸を通す](/images/tennis-0601-chin-tuck.svg)
...
<!-- ▼▼▼ 楽天アフィリエイト：姿勢サポート（骨盤クッション／ストレッチポール）▼▼▼ -->
<!-- 【使い方】楽天アフィリエイトで「骨盤 クッション」または「ストレッチポール」の商品リンク（picttext形式）を生成し、下の REPLACE_ から始まるダミーを、生成したHTMLブロックに丸ごと置き換えてください。これまでの記事と同じカード型リンクになります。 -->
<table border="0" cellpadding="0" cellspacing="0"><tr><td><div style="border:1px solid #95a5a6;border-radius:.75rem;background-color:#FFFFFF;width:504px;margin:0px;padding:5px;text-align:center;overflow:hidden;"><table><tr><td style="width:240px"><a href="REPLACE_WITH_RAKUTEN_AFFILIATE_URL" target="_blank" rel="nofollow sponsored noopener" style="word-wrap:break-word;"><img src="REPLACE_WITH_PRODUCT_IMAGE_URL" border="0" style="margin:2px" alt="[商品価格に関しましては、リンクが作成された時点と現時点で情報が変更されている場合がございます。]" title="[商品価格に関しましては、リンクが作成された時点と現時点で情報が変更されている場合がございます。]"></a></td><td style="vertical-align:top;width:248px;display: block;"><p style="font-size:12px;line-height:1.4em;text-align:left;margin:0px;padding:2px 6px;word-wrap:break-word"><a href="REPLACE_WITH_RAKUTEN_AFFILIATE_URL" target="_blank" rel="nofollow sponsored noopener" style="word-wrap:break-word;">REPLACE_WITH_PRODUCT_NAME（例：骨盤サポート 姿勢 クッション 座椅子／ストレッチポール EX）</a><br><span >価格：0,000円（税込、送料別)</span> <span style="color:#BBB">(2026/6/1時点)</span></p><div style="margin:10px;"><a href="REPLACE_WITH_RAKUTEN_AFFILIATE_URL" target="_blank" rel="nofollow sponsored noopener" style="word-wrap:break-word;"><img src="https://static.affiliate.rakuten.co.jp/makelink/rl.svg" style="float:left;max-height:27px;width:auto;margin-top:0" ></a><a href="REPLACE_WITH_RAKUTEN_AFFILIATE_URL" target="_blank" rel="nofollow sponsored noopener" style="word-wrap:break-word;"><div style="float:right;width:41%;height:27px;background-color:#bf0000;color:#fff!important;font-size:12px;font-weight:500;line-height:27px;margin-left:1px;padding: 0 12px;border-radius:16px;cursor:pointer;text-align:center;"> 楽天で購入 </div></a></div></td></tr></table></div><br><p style="color:#000000;font-size:12px;line-height:1.4em;margin:5px;word-wrap:break-word"></p></td></tr></table>
<!-- ▲▲▲ 楽天アフィリエイト：姿勢サポート ▲▲▲ -->
...
- [テニスのフォアハンド｜『腕・上半身・下半身』3種類のスイングと、サーブの捻り戻し・狙って打つテニス脳（5/30）](/blog/tennis-0530-forehand-3types/)
...
*※ この記事は1人のテニスプレーヤーの主観的な気づきメモです。姿勢や体の痛みに不安がある場合は、医療機関や専門家にご相談ください。*
